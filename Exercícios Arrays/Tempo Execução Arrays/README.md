...
O programa preenche e soma os valores na matriz duas vezes, uma no padrão linha-coluna e outra na coluna-linha. Depois usa o clock() para medir o tempo em segundos de cada abordagem e imprime os resultados e os tempos.
